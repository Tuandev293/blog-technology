...
import CommentAddNew from "../module/comment/CommentAddNew";
import ListComment from "../module/comment/ListComment";
      ...
      <Layout>
        <div className="container">
          ...
          <div className="post-content">
            ...
            ></div>
            <AuthorBox userId={userInfo?.uid}></AuthorBox>
            {userInfo && userInfo.uid ? (
              <CommentAddNew postId={postInfo?.id}></CommentAddNew>
            ) : (
              <span>Bạn phải đăng nhập để bình luận</span>
            )}
            <ListComment postId={postInfo?.id}></ListComment>
          </div>
